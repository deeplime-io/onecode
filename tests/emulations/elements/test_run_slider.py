...
def test_execute_single_count():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    x = onecode.slider('my_slider', 0.5)
...
def test_execute_multiple_count():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    x = onecode.slider('my_slider', [0.5, 0.5], count=3)
    with open("stdout.txt", 'w') as f:
        f.write(str(x))
    """)
...
def test_load_then_execute_multiple_count():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    x = onecode.slider('my_slider', 0.5, count=4)
    with open("stdout.txt", 'w') as f:
        f.write(str(x))
    """)
    ...
    params = os.path.join(flow_dir, 'params.json')
    with open(params, 'w') as f:
        json.dump({"my_slider": [0.6, 0.4, 0.3]}, f)
...
def test_execute_invalid_bounds():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', 0.5, min=0.8, max=0.4)
    ...
    with open(os.path.join(flow_dir, 'stdout.txt')) as f:
        assert f.read() == "[my_slider] Minimum cannot be greater than maximum: 0.8 > 0.4"
...
def test_execute_invalid_min():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', 0.5, min=0.51, max=0.8)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
    ...
    with open(os.path.join(flow_dir, 'stdout.txt')) as f:
        assert f.read() == "[my_slider] Value lower than minimum: 0.5 < 0.51"
...
def test_load_then_execute_invalid_min():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', 0.6, min=0.51, max=0.8)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
...
def test_execute_invalid_max():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', 0.5, min=0.4, max=0.49)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
    ...
    with open(os.path.join(flow_dir, 'stdout.txt')) as f:
        assert f.read() == "[my_slider] Value greater than maximum: 0.5 > 0.49"
...
def test_load_then_execute_invalid_max():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', 0.45, min=0.4, max=0.49)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
...
def test_execute_invalid_with_count():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', [0.5, 0.45, 0.45], min=0.4, max=0.49, count=3)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
...
def test_load_then_execute_invalid_with_count():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', 0.45, min=0.4, max=0.49, count=4)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
    ...
    params = os.path.join(flow_dir, 'params.json')
    with open(params, 'w') as f:
        json.dump({"my_slider": [0.45, 0.5, 0.45]}, f)
...
def test_execute_optional_value():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    x = onecode.slider('my_slider', None, optional=True)
    with open("stdout.txt", 'w') as f:
        f.write(str(x))
    """)
...
def test_load_then_execute_optional_value():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    x = onecode.slider('my_slider', 0.5, optional=True)
    with open("stdout.txt", 'w') as f:
        f.write(str(x))
    """)
...
def test_execute_invalid_optional_value():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', None, optional=False)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
    ...
    with open(os.path.join(flow_dir, 'stdout.txt')) as f:
        assert f.read() == "[my_slider] Value is required: None provided"
...
def test_load_then_execute_invalid_optional_value():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('my_slider', 0.5, optional=False)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
...
def test_invalid_name_key():
    ...
    with open(os.path.join(flow_dir, 'flows', f'{flow_id}.py'), 'a') as f:
        f.write("""
    try:
        x = onecode.slider('_my_slider', 0.5)
    except ValueError as err:
        with open("stdout.txt", 'w') as f:
            f.write(str(err))
    """)
    ...
    with open(os.path.join(flow_dir, 'stdout.txt')) as f:
        assert f.read() == 'Key starting with "_" are reserved: _my_slider'
