...
def run():
    ...
    for dip in dip_angles:
        ...
        vario_params = [
            ...
            {"lag": 4, "lag_dist": 150, "plag": 75, "atol": 90, "azi": 0, "dip": dip, "pitch": 0 },
            {"lag": 3, "lag_dist": 80, "plag": 75, "atol": 90, "azi": 180, "dip": 90 - dip, "pitch": 90 },
        ]
    ...
    lags, tol = geo.generate_lags(lag=1.5, plag=75, nlags=6)
